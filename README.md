...
[![GitHub stars](https://img.shields.io/github/stars/winkovo0818/boss-plugin.svg?style=social&label=Star)](https://github.com/winkovo0818/boss-plugin)

**[🚀 快速开始](#安装方法) | [📚 使用文档](#-使用说明) | [✨ 功能特点](#-功能特点)**
...
✅ **解决方案：**
- **智能匹配** - 秒级分析简历与岗位JD，给出0-100分匹配度
- **去AI味** - 生成真人般自然的打招呼，用"做过、降了、挺感兴趣"
- **一键3风格** - 单次AI调用生成3种风格，节省66%成本
...
| 特性 | 说明 | 优势 |
|------|------|------|
| 🤖 **AI驱动** | 支持OpenAI/Kimi/Claude/智谱AI/通义千问 | 多模型选择 |
| 🗣️ **去AI味** | 口语化prompt，真人般表达 | HR无法识破 |
| 💰 **成本优化** | 3风格一次生成 | 节省66% API调用 |
| 🔒 **隐私安全** | 自动过滤6类敏感信息 | 数据本地存储 |
| ⚡ **性能优化** | 智能缓存+防抖+重试 | 快速响应 |
| 🎨 **用户体验** | 现代化UI+流畅动画 | 操作简单 |
...
> 尊敬的HR，**贵司**数据分析师岗位与**本人**2年Python+SQL建模经验**高度契合**。**于**腾讯集团**主导**供应链智能补货系统，**构建**A/B/C分层模型...
...
> 您好，看到**贵公司**的数据分析岗，**我**2年Python+SQL经验**比较匹配**。**在**腾讯**做过**供应链补货系统，**搭了**ABC分层模型，库存积压**降了**10%...
...
* 使用统计 - 统计历史、匹配度分布、使用情况*

![历史记录](images/history.png)
* 历史记录管理 - 支持单条删除、批量清空，精确控制*



```
1️⃣ 安装插件 → 2️⃣ 配置AI → 3️⃣ 上传简历 → 4️⃣ 开始使用
```
...
<details>
<summary><b>Q1: 为什么生成的打招呼还是有点AI味？</b></summary>
...
<details>
<summary><b>Q2: 支持哪些AI服务？</b></summary>
...
<details>
<summary><b>Q3: PDF简历解析失败怎么办？</b></summary>
...
<details>
<summary><b>Q4: 一键生成3风格真的只调用1次API吗？</b></summary>

是的！通过优化prompt，让AI一次返回3种风格的JSON数据，节省66%成本。
...
| 项目 | 说明 |
|-----|------|
| 🌐 使用场景 | 请在BOSS直聘岗位详情页使用 |
| 📄 文件大小 | 简历文件建议不超过5MB |
| 🤖 API配置 | 强烈建议配置Kimi API获得最佳效果 |
| 📝 TXT格式 | TXT格式简历无需配置即可使用 |
| 📊 分析结果 | 匹配分析结果仅供参考 |
